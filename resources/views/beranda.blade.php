...
<body>
    ...
    <div class="card-grid">
      @forelse($fasilitas ?? [] as $item)
        <div class="media-card">
          <div class="image-placeholder">
            @if(!empty($item->foto))
              <img src="{{ asset('storage/' . $item->foto) }}" alt="{{ $item->deskripsi ?? 'Fasilitas' }}">
            @endif
          </div>
  ...
  <section id="pengajar">
    ...
    <div class="teacher-search">
      <span>🔍</span>
      <input type="text" id="teacherSearch" placeholder="Cari nama pengajar..." autocomplete="off">
    </div>
        ...
        @forelse($pengajar ?? [] as $item)
          <tr class="teacher-row">
            <td class="teacher-photo-cell">
              @if(!empty($item->foto))
                <img src="{{ asset('storage/' . $item->foto) }}" alt="Foto {{ $item->nama_lengkap ?? 'Pengajar' }}"
                  class="teacher-photo">
              @else
    ...
    <div class="contact-box">
      <div class="contact-info">
        ...
        <div class="social-links">
          <a href="https://www.instagram.com/rq.al_falahbjm?igsh=MWMxNzNkNTFkbmJpZw==" target="_blank"
            aria-label="Instagram Rumah Tahfidz Al-Falah" class="instagram-icon">
          ...
          <a href="https://wa.me/6287814678787" target="_blank" aria-label="WhatsApp Rumah Tahfidz Al-Falah"
            class="whatsapp-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.33 4.95L2 22l5.27-1.38a9.86 9.86 0 0 0 4.77 1.22h.01c5.46 0 9.91-4.45 9.91-9.91C21.96 6.45 17.5 2 12.04 2Zm0 18.15h-.01a8.2 8.2 0 0 1-4.18-1.14l-.3-.18-3.13.82.84-3.05-.2-.31a8.17 8.17 0 0 1-1.25-4.38c0-4.53 3.69-8.22 8.23-8.22 2.2 0 4.26.86 5.81 2.41a8.18 8.18 0 0 1 2.41 5.82c0 4.54-3.69 8.23-8.22 8.23Zm4.51-6.16c-.25-.12-1.47-.73-1.69-.81-.23-.08-.39-.12-.56.12-.17.25-.64.81-.79.98-.15.17-.29.19-.54.06-.25-.12-1.05-.39-2-1.23-.74-.66-1.24-1.47-1.39-1.72-.14-.25-.01-.38.11-.5.11-.11.25-.29.37-.44.12-.15.17-.25.25-.41.08-.17.04-.31-.02-.44-.06-.12-.56-1.35-.76-1.85-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.44.06-.67.31-.23.25-.88.86-.88 2.1s.9 2.44 1.03 2.61c.12.17 1.77 2.71 4.3 3.8.6.26 1.07.41 1.44.52.6.19 1.15.16 1.58.1.48-.07 1.47-.6 1.68-1.18.21-.58.21-1.08.15-1.18-.06-.11-.23-.17-.48-.29Z" />
      ...
      <div class="map-box">
        ...
        <a href="https://maps.app.goo.gl/SzQJUCzztonLuGsNA" target="_blank" rel="noopener" class="map-click-area"
    ...
    <div class="footer-container">
      ...
      <div class="footer-col">
        ...
        <div class="footer-social">
          <a href="https://www.instagram.com/rq.al_falahbjm?igsh=MWMxNzNkNTFkbmJpZw==" target="_blank"
            rel="noopener noreferrer" aria-label="Instagram Rumah Tahfidz Al-Falah">
            📷
          </a>
